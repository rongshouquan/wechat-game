...
var RACES = {
  goblin: {
    id: 'goblin',
    name: '哥布林',
    image: 'assets/characters/race_goblin.png',
    role: '群伤/燃烧',
    baseHp: 600,
    baseAtk: 40,
  ...
  werewolf: {
    id: 'werewolf',
    name: '狼人',
    image: 'assets/characters/race_werewolf.png',
    role: '切后排',
    baseHp: 800,
    baseAtk: 55,
    baseAtkSpeed: 0.9,
  ...
  minotaur: {
    id: 'minotaur',
    name: '牛头怪',
    image: 'assets/characters/race_minotaur.png',
    role: '坦克/控制',
    baseHp: 1600,
    baseAtk: 35,
    baseAtkSpeed: 1.5,
  ...
  orc: {
    id: 'orc',
    name: '兽人',
    image: 'assets/characters/race_orc.png',
    role: '狂战士',
    baseHp: 1200,
    baseAtk: 60,
    baseAtkSpeed: 1.0,
  ...
  skeletonMage: {
    id: 'skeletonMage',
    name: '骷髅法师',
    image: 'assets/characters/race_skeleton_mage.png',
    role: '高爆发单体',
    baseHp: 560,
    baseAtk: 70,
    baseAtkSpeed: 1.3,
  ...
  fairy: {
    id: 'fairy',
    name: '小精灵',
    image: 'assets/characters/race_fairy.png',
    role: '辅助/治疗',
    baseHp: 500,
    baseAtk: 0,  // 普攻是治疗
    baseHeal: 30,
  ...
  paladin: {
    id: 'paladin',
    name: '圣骑士',
    image: 'assets/characters/race_paladin.png',
    role: '辅助/保护',
    baseHp: 700,
    baseAtk: 20,
    baseAtkSpeed: 1.4,
  ...
  reaper: {
    id: 'reaper',
    name: '死神',
    image: 'assets/characters/race_reaper.png',
    role: '高爆发/收割',
    baseHp: 640,
    baseAtk: 65,
    baseAtkSpeed: 1.1,
