# Codex指令 · 第39批 · 回退34批 + Ron 五项改动

> **基线=34批（家族脸+本色+驾驶员·Ron 判"通过·明显进步"）**。在其上只做 Ron 5 项改动，其余逐字照 34 批不动：
> ① **加回标题**（34 批留白→画大标题"星舰小队"）；
> ② **泡舱改小圆泡舱 + 加"看不清的通用驾驶员人影 + 操作台剪影"**（34 批是"大泡舱·空·无人"）；
> ③ **炮击炮管上机头**（34 批"背驮"→机头前方）；
> ④ **护卫改光滑盔甲**（34 批"机首盾板"→光滑盔甲）；
> ⑤ **影刃改深莓**（34 批"blueberry-blue"→deep berry/grape-blue）。
> **配套（因②放人影）**：avoid 里"any pilot sitting inside a cockpit"改为"禁清晰驾驶员/清晰人脸、允许模糊看不清剪影"。**星徽/迷雾/敌方/驾驶员站台/背景等一字未动。**
...
Avoid: dark or deep-navy mood, large dark nebula masses, panel lines, rivets, circuit patterns, honeycomb texture, mechanical greebles, realistic war machines, mecha look, any face or eyes on the ships, a clear recognizable pilot or a clear human face inside the cockpit (only a dim blurry unrecognizable silhouette is allowed inside), water, ocean, sailing ships.
```

---

## 验收要点（本批 5 项逐条验 + 34 批已过项不回退）

1. **标题**：顶部有大的"星舰小队"糖果标题。
2. **泡舱小圆 + 里面有看不清的通用人影 + 操作台剪影**：泡舱不大；舱里透一个模糊的、看不清脸的通用驾驶员人影和一点操作台，**不是清晰的具体驾驶员**。
3. **炮击炮管在机头**：橙舰的炮装机头前方，不在背上。
4. **护卫是光滑盔甲**：护卫舰罩光滑糖果盔甲、没有盾板。
5. **影刃是深莓**：突击舰深莓紫蓝、比护卫的天蓝深、更偏紫。
6. **34 批已过项不回退**：家族脸（同款胖圆壳）、每舰本色、糖果味、驾驶员站台、敌方/星港岛、五舰身上的小星徽（保留）。

## 定稿与回流

- Ron 挑中 1 张＝五舰长相定稿候选（锁样归 Ron）；锁定后拷 `美术素材/锁样定稿/`，3/4 母版与俯视 sprite 批照定稿派生。
- 出图归档 `F:\星舰小队Codex输出\第39批.../`（**平铺·不建抽N子夹**）；挑选夹改名 `39-海报-抽N`。
