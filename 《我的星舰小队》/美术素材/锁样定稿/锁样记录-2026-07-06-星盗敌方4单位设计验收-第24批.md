...
- **星盗头目：删"炮口蓄力光效"**。第24批身份词写死了 "glowing energy core building up at the muzzle"（蓄力读法），实图炮口带粉色光团。资产版一律**纯净体出图，光效由引擎特效后加**——正式资产批的头目身份词删除 muzzle glow 相关句、炮口画成干净炮管。
- 该原则推广：所有战斗单位资产=纯净体（无光效/无弹道/无投影），动态表现归引擎。
