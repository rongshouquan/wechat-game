# Codex 指令 · 第27批 · 我方五舰补一点糖果Q萌 + hub 回18批只加漂浮梦幻
...
- **（装配页本批不做——26批方向已获认可、待五舰定后由 Ron 决定锁样。）**

---

## B 段 · 我方五舰单体 sprite（每舰抽 3）

> **本段唯一改动（相对26批·最小手术）**：26批五舰已成功读成"太空飞船"（徽章病治好），只是**偏硬核酷帅、缺一点糖果Q萌**。修法＝**只删掉26批那段"酷炫战机(sleek/heroic/cool starfighter)"锚**，**再补一句很轻的萌词、萌度对标本作星盗单位（不过火、不许比星盗更玩具/更软圆）**。身份词剖形/配色/线条/朝向/实底/硬约束＝26批原样，一字不动。五舰各长各的、不搞阵营统一。
...
> **本段唯一改动（相对18批金标准·最小手术）**：18批金标准是现存最亮最艳的 hub（Ron 认"鲜艳清澈透亮"）。26批为了"外太空"把背景写成 "deep starry night sky" 夜空词＝出成深黑夜空。修法＝**回18批原提示词、一字不改**，**只在背景那句加上 Ron 要的"轻飘飘漂浮+梦幻奇幻感"**（这是 Ron 明确点名要的），**不额外加任何"调亮/白天/别发暗"补偿词**（18批本来就亮，删掉夜空词即可）。深黑夜空版不浪费＝留作未来夜间模式皮肤。（另：18批原词那句"用附带海报当参考图"因工具无参考图输入＝空转，改写成纯文字风格目标句、保留有用的"配色丰富/糖果光泽/鲜活"。）
...
- **B 五舰（最小手术补萌）**：只删26批"sleek/heroic/cool 酷炫战机"锚 + 补一句很轻的萌词（对标星盗萌度、明确"不比星盗更萌/更玩具"防过火）。身份词/线条/硬约束/朝向＝26批原样。避免"为治硬核而堆糖果软圆胖乎乎"过火（Ron 预警：会变太玩具、跟星盗不是一个味）。
- **C hub（最小手术回18批+漂浮）**：回18批金标准原词一字不改，只在背景句加 Ron 要的"轻飘飘漂浮+梦幻奇幻"；删净26批的夜空/深空词，**不额外加"调亮/白天"补偿词**（18批本来就亮）。深黑版留作未来夜间皮肤。
