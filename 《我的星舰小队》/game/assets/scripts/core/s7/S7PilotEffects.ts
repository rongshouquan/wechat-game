...
// ⚠️ 段二 A3 封存注记（2026-07-12）：等级上限 100→50——本表 lv≥60 档（Lv60/100 天赋里程碑）随
//   51-100 段封存未来版本（A3 原文"驾驶员 Lv60/100 天赋里程碑移未来版本"·代码保留不删·不可达）；
//   Lv20/40 天赋门原位有效（大节点账本=S7GrowthNodes）。
//
// 口径（细表 §13 / 驾驶员真源 §0）：
